...
public class H_frag_recyclervi_nbu__yiying_adapter extends RecyclerView.Adapter<H_frag_recyclervi_nbu__yiying_adapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("path",mList.get(17).get_$88011().getTag().get(position).getPicUrl());
                intent.putExtra("name",mList.get(17).get_$88011().getTag().get(position).getElementName());
    ...
    public int getItemCount() {
        return mList.get(17).get_$88011().getTag().size();
    }
