...
public class H_frag_recyclervi_nbu__shangxin_yuer_adapter extends RecyclerView.Adapter<H_frag_recyclervi_nbu__shangxin_yuer_adapter.ViewHolder> {
    private List<Home_frag1_bean.DataBean> mList;
    private Context mContext;

    public H_frag_recyclervi_nbu__shangxin_yuer_adapter(List<Home_frag1_bean.DataBean> list, Context context) {
        mList = list;
        mContext = context;
    }
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        Glide.with(mContext)
                .load(Url.tupin+mList.get(17).getTag().get(position).getPicUrl())
                .into(holder.img_fr1_adap_review_imgnbu2_haoqi);
        String elementName = mList.get(17).getTag().get(position).getElementName();
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("path",mList.get(17).getTag().get(position).getPicUrl());
                intent.putExtra("name",mList.get(17).getTag().get(position).getElementName());
    ...
    public int getItemCount() {
        return mList.get(17).getTag().size();
    }
