...
public class H_frag_recyclervi_nbu__haioqi_adapter extends RecyclerView.Adapter<H_frag_recyclervi_nbu__haioqi_adapter.ViewHolder> {
    private List<Home_frag1_bena_nbu.DataBean> mList;
    private Context mContext;

    public H_frag_recyclervi_nbu__haioqi_adapter(List<Home_frag1_bena_nbu.DataBean> list, Context context) {
        mList = list;
        mContext = context;
    }
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        Glide.with(mContext)
                .load(Url.tupin+mList.get(15).get_$88011().getTag().get(position).getPicUrl())
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("path",mList.get(15).get_$88011().getTag().get(position).getPicUrl());
                intent.putExtra("name",mList.get(15).get_$88011().getTag().get(position).getElementName());
    ...
    public int getItemCount() {
        return mList.get(15).get_$88011().getTag().size();
    }
